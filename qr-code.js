...
let cc = `╔════◇
║『 *THANKS FOR CHOOSING XLICON-MD* 』
║ _You complete first step to making Bot._
╚════════════════════════╝
╔═════◇
║  『•••Xlicon_session•••』
║📤 *1.Github:* [ github.com/salmanytofficial/XLICON-MD ]
║▶ *2.Ytube:* [ youtube.com/infinite9452 ]
║⭕ *3.Owner:* [ https://wa.me/8801853262586 ]
 |📍 *4.Support:* [ https://chat.whatsapp.com/GqLQLnl0tHr2ZHV4UcEl5g ]
║ *Note :*_Don't provide your SESSION_ID to_
║ _anyone otherwise that can access chats_
╚════════════════════════╝
`;
          let session_id = await session.sendMessage(user, { text: "XLICON-MD;;;"+ c });      //SENDING 'base64' SESSION ID TO USER NUMBER
